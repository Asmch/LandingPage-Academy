...
export function FlipWordsDemo() {
  ...
  return (
    <div className="h-auto flex justify-center items-center px-2 sm:px-4">
      <div className="text-base xs:text-lg sm:text-2xl md:text-3xl lg:text-4xl mx-auto font-normal text-neutral-600 dark:text-neutral-400 text-center leading-snug">
